unit URelMov_MensalEvento_Aluno2;
...
type
  TfRelMov_MensalEvento_Aluno2 = class(TForm)
    RLReport1: TRLReport;
...
var
  fRelMov_MensalEvento_Aluno2: TfRelMov_MensalEvento_Aluno2;

implementation

uses StdCtrls, ToolEdit, DB, UConsMov_MensalEvento2,
  UConsMov_MensalEvento_Aluno;

{$R *.dfm}

procedure TfRelMov_MensalEvento_Aluno2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelMov_MensalEvento_Aluno2.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  i : Integer;  
begin
  RLLabel1.Caption := 'Relatório do Evento (' + fConsMov_MensalEvento2.mEventoNomeEvento.AsString + ')';
...
procedure TfRelMov_MensalEvento_Aluno2.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vVlrTotalAux : Real;
  i : Integer;
